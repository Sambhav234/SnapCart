...
function UserOrderCard({ order }: { order: IOrder }) {
  ...
  >
     <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-3 border-b border-gray-100 px-5 py-4 bg-linear-to-r from-green-50 to-white'>
             ...
             {order.paymentMethod == "cod" ? <div className='flex items-center gap-2 text-gray-700 text-sm mx-4 py-3'>
                    <Truck size={16} className='text-green-600' />
                    Cash On Delivery
                </div> : <div className='flex items-center gap-2 text-gray-700 text-sm py-3'>
